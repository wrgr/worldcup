...
- a **"Who wins it all" ranking** — every remaining team by the model's odds to reach the quarterfinals, semifinals, final, and win the title (full-bracket propagation), shown on the page and formatted for desktop and mobile
...
- centered on the **quarterfinals onward** by default now that the Round of 32 and Round of 16 are complete; a **Full bracket** toggle reveals the earlier rounds (their results still feed the later cards)
